...
st.set_page_config(layout="wide",page_title="PF Report Generator",page_icon = icon_img)
...
with col_h2:
    st.markdown("""
            # ProntoForms Audit Report Generator
            """)

        #  Welcome 👋 \n
        # Generate a report based on the data collected during audit.
...
if check_password():
    ...
    with st.sidebar.expander("ABOUT THE APP"):
        st.markdown("""
                Each form submitted during Audit activities is
                automatically saved in the cloud.
                Based on the collected data and specific user selections
                this app will generate dedicated report deliverable.
                """)
...
#       GENERATING REPORT       #
            ...
            if generate_button:
                ...
                if (not prescreen_selection):
                    ...
                    a_df = get_csvsource('s3-nvent-prontoforms-data/Data_sources/audit_rep_text.csv')
...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        ...
        try:
            ...
            # mat_df_type_graph = mat_df_type.groupby(['Project','Form','ID','Material']).agg({'Quantity':'sum'}).reset_index()
